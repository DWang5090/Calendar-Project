...
public class CalendarDriver {
	...
	public static void getClassificationField(Scanner keybd, Calendar calendar) {
		...
		while ( !input.equalsIgnoreCase("public") && !input.equalsIgnoreCase("private") && !input.equalsIgnoreCase("confidential")) {
	...
	public static void getTimeZoneField(Scanner keybd, Calendar calendar) {
		...
		String[] negGMToffsets = {"(WAT)", "(AT)", "", "(AST)", "(EST)", "(CST)", "(MST)", "(PST)", "(YST)", "(HST)", "(NT)", "(IDLW)"};
